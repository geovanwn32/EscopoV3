...
import { Calculator, Plus, Trash2, Loader2, FileText, BookCopy, ChevronsUpDown, Check, Search, FileUp, Sparkles } from 'lucide-react';
        ...
        resultados.forEach((res, index) => {
            ...
            autoTable(doc, {
                body: [
                    ...
                    [
                        `Nome: Ágio Soluções em Software Ltda\nCNPJ: 62.667.939/0001-61`,
